            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-red">
                        <div class="panel-heading">修改餐品</div>
                        <div class="panel-body">
                            ...
                            <form id="editFoodForm" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="fphoto" id="fphoto" value="${food.fphoto}"/>
                                <input type="hidden" name="fsales" value="${food.fsales}"/>
                                <div class="form-group">
                                    <label>餐品名称</label>
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <input class="form-control" type="text" name="fname" value="${food.fname}"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <input class="form-control" type="text" name="fprice" value="${food.fprice}"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <select name="ftid" class="form-control">
                                                <c:forEach items="${foodTypes}" var="type">
                                                    <option value="${type.id}" ${food.ftid == type.id ? 'selected' : ''}>${type.ftname}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
    									...
    									<!--<div  id="thelist" class="uploader-list"></div>  -->
    										<div id="thelist" class="uploader-list">
    											<img src="http://7xkr3z.com1.z0.glb.clouddn.com/${food.fphoto}-size200" alt=""/>
    										</div>
    								</div>
									</div></div>
                                        <div class="col-xs-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <input class="form-control" type="text" name="findex" value="${food.findex}"/>
                                        </div>
                                    </div>
                                </div>
